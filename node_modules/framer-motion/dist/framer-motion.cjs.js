...
function animateVisualElement(visualElement, definition, options) {
    ...
    return animation.then(function () { return visualElement.notifyAnimationComplete(); });
}
...
function animateChildren(visualElement, variant, delayChildren, staggerChildren, staggerDirection, options) {
    ...
    Array.from(visualElement.variantChildren)
        ...
        animations.push(animateVariant(child, variant, tslib.__assign(tslib.__assign({}, options), { delay: delayChildren + generateStaggerDuration(i) })));
    });
