 ...
 * @internal
 */
export declare function createMotionComponent<P extends {}, E>(Component: string | React.ComponentType<P>, { defaultFeatures, createVisualElement, useRender, }: MotionComponentConfig<E>): React.ForwardRefExoticComponent<React.PropsWithoutRef<P & MotionProps> & React.RefAttributes<E>>;

declare type CreateVisualElement<E, P = MotionProps> = (Component: string | React_2.ComponentType<P>, isStatic: boolean, options: VisualElementOptions<E>) => VisualElement<E>;
...
declare interface LifecycleManager {
    ...
    onLayoutAnimationComplete: (callback: AnimationCompleteListener) => () => void;
 ...
 * @public
 */
export declare function useAnimation(): import("./animation-controls").AnimationControls;
 ...
 */
declare interface VisualElementLifecycles {
    /**
